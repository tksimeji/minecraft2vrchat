...
{
    public enum M2VLanguage
    {
        English,
        Japanese
    }

    internal static class M2VLocalization
    {
        internal static string Get(M2VLanguage language, string key)
        {
            return language == M2VLanguage.Japanese
                ? GetJapanese(key)
                : GetEnglish(key);
        }
